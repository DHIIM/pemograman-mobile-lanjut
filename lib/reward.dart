...
import 'package:telkomselku/beranda.dart';
import 'package:telkomselku/lifestyle.dart'; // Replace with the correct imports
...
class _RewardScreenState extends State<RewardScreen> {
  ...
  Widget _buildRewardItem(
      String title, String imagePath, String points, String description) {
    return Expanded(
      child: Container(
